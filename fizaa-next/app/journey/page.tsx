      ...
      <section className="py-14 sm:py-24 bg-cream">
        <div className="container-site">
          ...
          <div className="grid gap-[18px] max-w-[820px]">
            ...
            <TL year={t("Field")} h={t("On the ground, every deal")} p={t("Every deal starts with a site visit. Fizaa walks the property — rain or shine — so clients get accurate, first-hand information, not recycled brochure data.")} />
          </div>
        </div>
      </section>
        ...
        <div className="container-site">
          ...
          {projects.length === 0 ? (
            <div className="text-center border border-dashed border-line-strong rounded-xl2 py-12 px-6">
              ...
              <p className="text-mute mb-4">{t("Fizaa's latest industrial & commercial projects will appear here.")}</p>
