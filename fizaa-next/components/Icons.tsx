...
export const Mail = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}><path d="M4 4h16v16H4z" /><path d="m22 6-10 7L2 6" /></svg>
);
...
export const Building = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}><path d="M3 21h18M5 21V7l8-4v18M19 21V11l-6-3" /></svg>
);
